...
public class UsersController {
    ...
    public String index(
        ...
        return "admin/Users/index"; // Đường dẫn tới view index.html
    }
    ...
    public String editForm(@PathVariable int id, Model model) {
        ...
        return "Users/edit"; // Trả về đường dẫn 'user/edit.html'
    }
    ...
    public String updateUser(
        ...
        if (bindingResult.hasErrors()) {
            return "users/edit"; // Hiển thị lại form chỉnh sửa nếu có lỗi
        }
